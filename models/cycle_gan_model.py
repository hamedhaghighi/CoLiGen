...
class CycleGANModel(BaseModel):
    ...
    def backward_G(self):
        ...
        self.loss_cycle_A = (
            self.criterionCycle(self.rec_A, self.real_A) * self.opt.model.lambda_A
        )
        # Backward cycle loss || G_A(G_B(B)) - B||
        self.loss_cycle_B = (
            self.criterionCycle(self.rec_B, self.real_B) * self.opt.model.lambda_B
        )
