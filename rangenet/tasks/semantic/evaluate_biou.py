...
if __name__ == "__main__":
    ...
    for scan_file, label_file, pred_file in zip(scan_names, label_names, pred_names):
        ...
        evaluator.addBorderBatch1d(
            p_label_sem, u_pred_sem, u_label_sem, u_scan_px, u_scan_py
        )
    ...
    print(
        ...
        "bIoU avg {m_jaccard:.3f}".format(m_accuracy=m_accuracy, m_jaccard=m_jaccard)
    )
