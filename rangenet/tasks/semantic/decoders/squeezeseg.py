...
class FireUp(nn.Module):
    ...
    def __init__(
        self, inplanes, squeeze_planes, expand1x1_planes, expand3x3_planes, stride
    ):
...
class Decoder(nn.Module):
    ...
    def __init__(self, params, stub_skips, OS=32, feature_depth=512):
        ...
        self.firedec10 = FireUp(
            self.backbone_feature_depth, 64, 128, 128, stride=self.strides[0]
        )
        ...
        self.layers = [self.firedec10, self.firedec11, self.firedec12, self.firedec13]
